...
<body>
  <div class="container">
    ...
    <div class="card">
      <div class="card-header">Laporan Triwulan 3 (Tiga)</div>
      <div class="card-body">
        ...
        <?php
          ...
          if (empty($pembayaran)) {
            echo '<h1>LAPORAN TRIWULAN III ZAKAT, INFAQ DAN SHADAQOH TAHUN ' . $tahun . '</h1>';
        } else {
            echo '<h1>LAPORAN TRIWULAN III ' . $pembayaran . ' TAHUN ' . $tahun . '</h1>';
        }
    ...
    $query_muzaki .= " AND (MONTH(tanggal) = 7 OR MONTH(tanggal) = 8 OR MONTH(tanggal) = 9) ";
