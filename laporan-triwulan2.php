...
<body>
  <div class="container">
    ...
    <div class="card">
      <div class="card-header">Laporan Triwulan 2 (Dua)</div>
      <div class="card-body">
        ...
        <?php
          ...
          if (empty($pembayaran)) {
            echo '<h1>LAPORAN TRIWULAN II ZAKAT, INFAQ DAN SHADAQOH TAHUN ' . $tahun . '</h1>';
        } else {
            echo '<h1>LAPORAN TRIWULAN II ' . $pembayaran . ' TAHUN ' . $tahun . '</h1>';
        }
    ...
    $query_muzaki .= " AND (MONTH(tanggal) = 4 OR MONTH(tanggal) = 5 OR MONTH(tanggal) = 6) ";
